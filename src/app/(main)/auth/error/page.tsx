...
import { FlexBox, FlexBoxDirection, FlexBoxJustifyContent, FlexBoxAlignItems, Text, Button } from "@ui5/webcomponents-react";
...
export default function AuthError() {
  ...
  return (
    ...
    >
      <Text style={{ fontSize: "1.5rem", fontWeight: "bold", color: "#ef4444", marginBottom: "1rem" }}>
        Authentication Error
      </Text>
      <Text style={{ marginBottom: "2rem", textAlign: "center", maxWidth: "400px" }}>
