    ...
    >
      <Card style={{ maxWidth: '500px', width: '100%' }}>
        ...
        >
          <Title
            level="H3"
            style={{ textAlign: 'center', color: 'var(--sapSuccessColor)' }}
          >
            ✓ Logout Successful
          </Title>

          <Text
            style={{ textAlign: 'center', color: 'var(--sapNeutralTextColor)' }}
          >
            You have been successfully logged out of your account. Your session
            has been terminated and all authentication tokens have been cleared.
          </Text>
          ...
          >
            To maintain security, you will need to re-authenticate when you sign
            in again.
          </Text>
