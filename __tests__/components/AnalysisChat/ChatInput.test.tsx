...
describe("ChatInput", () => {
  ...
  describe("Rendering", () => {
    it("renders the input and send button", () => {
      ...
      expect(screen.getByPlaceholderText("Write your lines here")).toBeInTheDocument();
      expect(screen.getByRole("button")).toBeInTheDocument();
    });

    it("disables input and button when isLoading is true", () => {
      render(<ChatInput onSendMessage={mockOnSendMessage} isLoading={true} />);
      expect(screen.getByPlaceholderText("Write your lines here")).toBeDisabled();
      expect(screen.getByRole("button")).toBeDisabled();
    });

    it("enables input and button when isLoading is false", () => {
      render(<ChatInput onSendMessage={mockOnSendMessage} isLoading={false} />);
      expect(screen.getByPlaceholderText("Write your lines here")).not.toBeDisabled();
  ...
  describe("Input behavior", () => {
    it("updates the input value on user typing", () => {
      render(<ChatInput onSendMessage={mockOnSendMessage} isLoading={false} />);
      const textarea = screen.getByPlaceholderText("Write your lines here") as HTMLTextAreaElement;
